#############################################################################
# Makefile for building: Avion
# Generated by qmake (3.0) (Qt 5.5.1)
# Project:  Pro/Avion.pro
# Template: app
# Command: /usr/lib/i386-linux-gnu/qt5/bin/qmake -o Makefile Pro/Avion.pro
#############################################################################
...
INCPATH       = -IPro -I. -isystem /usr/include/i386-linux-gnu/qt5 -isystem /usr/include/i386-linux-gnu/qt5/QtWidgets -isystem /usr/include/i386-linux-gnu/qt5/QtGui -isystem /usr/include/i386-linux-gnu/qt5/QtCore -I. -I. -I/usr/lib/i386-linux-gnu/qt5/mkspecs/linux-g++
...
COMPRESS      = gzip -9f
DISTNAME      = Avion1.0.0
DISTDIR = /media/sf_Desktop/Avion_XUNYUE_RAKOTOMANGA/.tmp/Avion1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
SOURCES       = Sources/fenetre.cpp \
		Sources/main.cpp \
		Sources/moteur.cpp \
		Sources/pompe.cpp \
		Sources/reservoir.cpp \
		Sources/test.cpp \
		Sources/vanne.cpp moc_fenetre.cpp
OBJECTS       = fenetre.o \
		main.o \
		moteur.o \
		pompe.o \
...
DIST          = /usr/lib/i386-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		Pro/Pro/Avion.pro Header/fenetre.h \
		Header/moteur.h \
		Header/pompe.h \
		Header/reservoir.h \
		Header/test.h \
		Header/vanne.h Sources/fenetre.cpp \
		Sources/main.cpp \
		Sources/moteur.cpp \
		Sources/pompe.cpp \
		Sources/reservoir.cpp \
...
Makefile: Pro/Avion.pro /usr/lib/i386-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/i386-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile Pro/Avion.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents Header/fenetre.h Header/moteur.h Header/pompe.h Header/reservoir.h Header/test.h Header/vanne.h $(DISTDIR)/
	$(COPY_FILE) --parents Sources/fenetre.cpp Sources/main.cpp Sources/moteur.cpp Sources/pompe.cpp Sources/reservoir.cpp Sources/test.cpp Sources/vanne.cpp $(DISTDIR)/
	$(COPY_FILE) --parents Pro/mainwindow.ui $(DISTDIR)/
...
moc_fenetre.cpp: Header/test.h \
		Header/reservoir.h \
		Header/pompe.h \
		Header/moteur.h \
		Header/vanne.h \
		Header/fenetre.h
	/usr/lib/i386-linux-gnu/qt5/bin/moc $(DEFINES) -I/usr/lib/i386-linux-gnu/qt5/mkspecs/linux-g++ -I/media/sf_Desktop/Avion_XUNYUE_RAKOTOMANGA/Pro -I/usr/include/i386-linux-gnu/qt5 -I/usr/include/i386-linux-gnu/qt5/QtWidgets -I/usr/include/i386-linux-gnu/qt5/QtGui -I/usr/include/i386-linux-gnu/qt5/QtCore -I. -I/usr/include/c++/5 -I/usr/include/i386-linux-gnu/c++/5 -I/usr/include/c++/5/backward -I/usr/lib/gcc/i686-linux-gnu/5/include -I/usr/local/include -I/usr/lib/gcc/i686-linux-gnu/5/include-fixed -I/usr/include/i386-linux-gnu -I/usr/include Header/fenetre.h -o moc_fenetre.cpp
...
ui_mainwindow.h: Pro/mainwindow.ui
	/usr/lib/i386-linux-gnu/qt5/bin/uic Pro/mainwindow.ui -o ui_mainwindow.h
...
fenetre.o: Sources/fenetre.cpp Header/fenetre.h \
		Header/test.h \
		Header/reservoir.h \
		Header/pompe.h \
		Header/moteur.h \
		Header/vanne.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o fenetre.o Sources/fenetre.cpp

main.o: Sources/main.cpp Header/fenetre.h \
		Header/test.h \
		Header/reservoir.h \
		Header/pompe.h \
		Header/moteur.h \
...
moteur.o: Sources/moteur.cpp Header/moteur.h \
		Header/pompe.h \
		Header/reservoir.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moteur.o Sources/moteur.cpp

pompe.o: Sources/pompe.cpp Header/pompe.h \
		Header/reservoir.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o pompe.o Sources/pompe.cpp

reservoir.o: Sources/reservoir.cpp Header/reservoir.h \
		Header/pompe.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o reservoir.o Sources/reservoir.cpp

test.o: Sources/test.cpp Header/test.h \
		Header/reservoir.h \
		Header/pompe.h \
		Header/moteur.h \
		Header/vanne.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o test.o Sources/test.cpp

vanne.o: Sources/vanne.cpp Header/vanne.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o vanne.o Sources/vanne.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/Avion/bin || mkdir -p $(INSTALL_ROOT)/opt/Avion/bin
	-$(INSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/Avion/bin/$(QMAKE_TARGET)
	-$(STRIP) $(INSTALL_ROOT)/opt/Avion/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/Avion/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/Avion/bin/ 
